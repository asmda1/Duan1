...
public class FormKhachHang extends javax.swing.JPanel {
    ...
    private void jLabel3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MousePressed
        ...
        if (txtTenKH.getText().isEmpty()) {
            listKH = new KhachHangDAO().select("Select DISTINCT dbo.KhachHang.* FROM dbo.KhachHang where  KhachHang.maKh  NOT IN (SELECT makh FROM dbo.KhachHang WHERE maKh='KH000')");
        } else {
            listKH = new KhachHangDAO().select("Select DISTINCT dbo.KhachHang.* FROM dbo.KhachHang  where tenKh like N'%" + txtTenKH.getText() + "%' and KhachHang.maKh  NOT IN (SELECT makh FROM dbo.KhachHang WHERE maKh='KH000')");
        }
