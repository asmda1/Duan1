 ...
 * @author Kanbi
 */
public class DetailsForm extends javax.swing.JDialog {

    /**
     * Creates new form DetailsForm
     */
    public DetailsForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetailsForm dialog = new DetailsForm(new javax.swing.JFrame(), true);
